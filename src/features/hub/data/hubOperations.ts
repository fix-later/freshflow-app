...
export type HubBatch = {
  ...
  arrivalTime: string;
  totalKg: number;
  status: 'approaching' | 'waiting' | 'checking' | 'quality_check' | 'completed';
  products: BatchProduct[];
};

export const HUB_BATCHES: HubBatch[] = [
  {
    id: 'inbound-1',
    code: 'BD-0713-01',
    marketName: 'Chợ đầu mối Bình Điền',
    ...
    status: 'approaching',
    products: [
      { id: 'p-1', name: 'Cà chua beef', unit: 'kg', expectedQuantity: 120, imageColor: '#E05252' },
      { id: 'p-2', name: 'Cải thìa', unit: 'kg', expectedQuantity: 85, imageColor: '#5FAF67' },
      { id: 'p-3', name: 'Khoai tây Đà Lạt', unit: 'kg', expectedQuantity: 160, imageColor: '#C99C52' },
      { id: 'p-4', name: 'Hành tây', unit: 'kg', expectedQuantity: 95, imageColor: '#D3B77B' },
    ],
  },
  {
    id: 'inbound-2',
    ...
    status: 'waiting',
    products: [
      { id: 'p-5', name: 'Xà lách lô lô', unit: 'kg', expectedQuantity: 75, imageColor: '#73A95E' },
      { id: 'p-6', name: 'Dưa leo', unit: 'kg', expectedQuantity: 110, imageColor: '#4F9A68' },
      { id: 'p-7', name: 'Ớt chuông đỏ', unit: 'kg', expectedQuantity: 68, imageColor: '#D84B45' },
    ],
  },
  {
    id: 'inbound-3',
    ...
    vehicle: '51D-195.44',
    driver: 'Lê Hoàng Nam',
    arrivalTime: 'Đã đến 06:18',
    totalKg: 260,
    status: 'quality_check',
    products: [
      { id: 'p-8', name: 'Thịt heo ba rọi', unit: 'kg', expectedQuantity: 90, imageColor: '#C77A76' },
      { id: 'p-9', name: 'Thịt heo xay', unit: 'kg', expectedQuantity: 70, imageColor: '#B96D69' },
    ],
  },
];
